    ...
    <section className=' min-h-[90vh] grid grid-cols-1 xl:grid-cols-8 '>
        ...
        <div className='md:col-span-5 flex items-center justify-center p-8 xl:p-16'>
          <div className='flex flex-col gap-8'>
            ...
            <span className='text-primary my-3 py-2 px-6 border-8 border-primary relative inline-block'>
              Products
            ...
            <p className='text-gray-500 text-2xl leading-[2.5rem]'>Help find solutions with intitutive and in accordance with client
            business goals. we provide a high-quality services.</p>
            <div className='flex flex-col  md:flex-row items-center gap-4'>
              <button className='w-full xl:w-auto bg-primary text-white py-2 px-8 rounded-xl text-xl font-bold'>Contact Us
              </button>

              <button className='w-full xl:w-auto flex items-center gap-4 py-2 px-8 justify-start text-left rounded-xl text-xl'> {" "}
        ...
        <div className=' md:col-span-3 flex items-center justify-center relative p-8'>
            ...
            />          
              <div className='relative bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center gap-2 max-w-[250px] mx-auto -mt-12 '>
                ...
                <img 
                  ...
                  className='w-10 h-10  object-cover rounded-full ring-1 ring-gray-300 -ml-4 bg-white'
                />
                ...
                <div className='flex items-center gap-2 text-lg  text-gray-500'>
                  <RiStarFill className='text-primary'/> 5.0 (3.1k Revece)
                </div>
          ...
          {/*Circle */}
          <div 
              className='absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 md:w-[380px] md:h-[380px] w-[280px] h-[280px] bg-white border-[10px] border-primary rounded-full -z-10'></div>

          {/*Logos */}
          <img 
            src='figma.png' 
            className='w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute top-[13%] right-[20%] xl:right-[10%]' />    
