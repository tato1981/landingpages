  ...
  return (
    <div className='p-8 flex flex-col gap-8 bg-gray-100'>
      ...
      <img 
            ...
            className='w-8 h-8 md:w-14 md:h-14  object-cover rounded-full  bg-white'
      />
      ...
      <img 
            ...
            className='w-10 h-10 md:w-16 md:h-16  object-cover rounded-full   bg-white'
      />
